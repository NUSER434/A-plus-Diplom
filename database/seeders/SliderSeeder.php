...
class SliderSeeder extends Seeder
{
    ...
    {
        Slider::create([
            'image_url' => 'https://pressroll.ru/upload/iblock/f64/f643810d9367fcf96f6acccbf4953643.jpg',
            'title' => 'Быстрый заказ без лишних хлопот',
            'subtitle' => 'Не хотите тратить время на изучение сайта? Мы сделали процесс заказа максимально простым! Оставьте свои контактные данные, и наш менеджер свяжется с вами, чтобы уточнить детали. Всего пару кликов — и ваш заказ уже в работе!',
            'button_text' => 'Быстрый заказ',
            'button_link' => '#',
        ]);
